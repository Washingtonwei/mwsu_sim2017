...
public class Orbit {
	...
	private final double MU = 2.97554E15; //gravitational parameter (this is km^3 / day^2 right now)

	//orbital elements
	private double t_0 = 7350.24607837; //epoch (variable will be used for last known time)
	...
	private double M_0 = 326.2322;      //degrees - mean anomaly at epoch (will be used for last known mean anomaly)
